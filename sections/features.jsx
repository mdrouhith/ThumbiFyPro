...
export default function Features() {
    ...
    const featuresData = [
        {
            icon: BotIcon,
            title: "Scene & Subject Control",
            description: "Direct the subject, mood, and composition with precise prompts.",
        },
        {
            icon: BrainIcon,
            title: "Smart Typography",
            description: "Auto‑balanced headline placement with high‑contrast readability.",
        },
        {
            icon: ZapIcon,
            title: "Multi‑Resolution Export",
            description: "Download HD, Full HD, or 4K without losing sharpness.",
        }
    ];
    ...
    return (
        <section className="mt-32" id="features">
            <SectionTitle
                title="Designed for thumbnail performance"
                description="Everything you need to craft thumbnails that stop the scroll and drive clicks."
            />
