    ...
    return (
        <>
            ...
            <motion.section className="flex flex-col items-center" id="home">
                ...
                >
                    <p>AI Thumbnail Generator for Creators.</p>
                ...
                >
                    Create scroll‑stopping thumbnails in minutes.
                </motion.h1>
                <motion.p className="text-center text-gray-100 text-base/7 max-w-md mt-6"
                    ...
                    transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
                >
                    Turn ideas into high‑impact thumbnails with cinematic styles, smart text layout, and instant exports.
                </motion.p>
                ...
                >
                    <a href="#studio" className="btn max-md:w-full glass py-3 text-center">
                        Start Generating
                    </a>
                    <a href="#reviews" className="btn max-md:w-full glass flex items-center justify-center gap-2 py-3">
